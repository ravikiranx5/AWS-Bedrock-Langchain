...
def write_result_to_s3(result_text, s3_output_path):
    ...
    s3_key = f"{s3_output_path}/bedrock_output_stCQglu.txt"
...
if __name__ == "__main__":
    ...
    # s3_input_folders = ["s3://ccdout-bucket/in_call_transcripts/"]
    ...
    custom_prompt = (
        "Analyze and provide Call Centre Industry standard metrics Ratings and KPI scores for the call transcript below  \n \n"
    )
